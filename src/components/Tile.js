...
export default function ({ number = 2, width = 117.5, height = 117.5 }) {
    let color = "white";
    ...
    return <div className="tile" style={{
        width: width, height: height, color: color, backgroundColor: NumberBgColor[number], boxShadow: boxShadow
    }}>
        {number}
    </div>
}